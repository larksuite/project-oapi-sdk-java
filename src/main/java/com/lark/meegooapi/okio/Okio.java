...
public final class Okio {
    ...
    /**
     * Returns a new source that buffers reads from {@code source}. The returned source will perform
    ...
    /**
     * Returns a new sink that buffers writes to {@code sink}. The returned sink will batch writes to
     * {@code sink}. Use this wherever you write to a sink to get an ergonomic and efficient access to
     * data.
     */
    ...
    /**
     * Returns a sink that writes to {@code socket}. Prefer this over {@link #sink(OutputStream)}
    ...
    /**
     * Returns a source that reads from {@code socket}. Prefer this over {@link #source(InputStream)}
