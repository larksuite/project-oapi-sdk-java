...
import static com.lark.meegooapi.okio.Util.arrayRangeEquals;
...
public class ByteString implements Serializable, Comparable<ByteString> {
     ...
     * {@code base64} is not a Base64-encoded sequence of bytes.
     */
    ...
    /**
     * Returns this byte string encoded as <a href="http://www.ietf.org/rfc/rfc2045.txt">Base64</a>.
     * In violation of the RFC, the returned string does not wrap lines at 76 columns.
     */
    ...
    /**
     * Returns a byte string that is a substring of this byte string, beginning at the specified index
     * until the end of this string. Returns this byte string if {@code beginIndex} is 0.
     */
