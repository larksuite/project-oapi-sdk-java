...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    /**
     * Like {@link OutputStream#write(byte[], int, int)}, this writes {@code byteCount} bytes of
     * {@code source}, starting at {@code offset}.
     */
    BufferedSink write(byte[] source, int offset, int byteCount) throws IOException;

    /**
     * Removes all bytes from {@code source} and appends them to this sink. Returns the number of
     * bytes read which will be 0 if {@code source} is exhausted.
     */
