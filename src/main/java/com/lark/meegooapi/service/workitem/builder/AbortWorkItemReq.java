...
public class AbortWorkItemReq extends BaseRequest {
    @Path
    ...
    public AbortWorkItemReq(Builder builder) {
    ...
    public AbortWorkItemReqBody getAbortWorkItemReqBody() {
        return this.body;
    }

    public void setAbortWorkItemReqBody(AbortWorkItemReqBody body) {
        this.body = body;
    }
    ...
    public static class Builder {
        ...
        public Builder isAborted(Boolean isAborted) {
            this.body.setIsAborted(isAborted);
            return this;
        }
        ...
        public AbortWorkItemReq build() {
            return new AbortWorkItemReq(this);
        }
