...
import com.lark.meegooapi.service.field.model.MultiSignalDetail;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class UpdateMultiSignalReq extends BaseRequest {
    @Path
    ...
    @Body
    private UpdateMultiSignalReqBody body;


    public UpdateMultiSignalReq() {
    }

    public UpdateMultiSignalReq(Builder builder) {
    ...
    public UpdateMultiSignalReqBody getUpdateMultiSignalReqBody() {
        return this.body;
    }

    public void setUpdateMultiSignalReqBody(UpdateMultiSignalReqBody body) {
        this.body = body;
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            headers = new HashMap<>();
            body = new UpdateMultiSignalReqBody();
        }
        ...
        public Builder details(List<MultiSignalDetail> details) {
            this.body.setDetails(details);
            return this;
        }

        public Builder updateType(String updateType) {
            this.body.setUpdateType(updateType);
            return this;
        }

        public UpdateMultiSignalReq build() {
            return new UpdateMultiSignalReq(this);
        }
