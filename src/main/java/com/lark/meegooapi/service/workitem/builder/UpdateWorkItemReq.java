...
public class UpdateWorkItemReq extends BaseRequest {
    @Path
    ...
    @Body
    private UpdateWorkItemReqBody body;


    public UpdateWorkItemReq() {
    }

    public UpdateWorkItemReq(Builder builder) {
    ...
    public UpdateWorkItemReqBody getUpdateWorkItemReqBody() {
        return this.body;
    }

    public void setUpdateWorkItemReqBody(UpdateWorkItemReqBody body) {
        this.body = body;
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            headers = new HashMap<>();
            body = new UpdateWorkItemReqBody();
        }
