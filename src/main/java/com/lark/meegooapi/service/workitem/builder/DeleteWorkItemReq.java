...
public class DeleteWorkItemReq extends BaseRequest {
    @Path
    ...
    public DeleteWorkItemReq() {
    }

    public DeleteWorkItemReq(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteWorkItemReq build() {
            return new DeleteWorkItemReq(this);
        }
