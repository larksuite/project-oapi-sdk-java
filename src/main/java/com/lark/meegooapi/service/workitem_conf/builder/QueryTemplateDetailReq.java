...
public class QueryTemplateDetailReq extends BaseRequest {
    @Path
    ...
    public QueryTemplateDetailReq(Builder builder) {
    ...
    public static class Builder {
        ...
        public QueryTemplateDetailReq build() {
            return new QueryTemplateDetailReq(this);
        }
