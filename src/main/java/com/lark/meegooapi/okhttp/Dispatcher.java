...
public final class Dispatcher {
     ...
     * on whether it was run {@linkplain Call#enqueue(Callback) asynchronously} or {@linkplain
     * Call#execute() synchronously}. Asynchronous calls become idle after the {@link
     * Callback#onResponse onResponse} or {@link Callback#onFailure onFailure} callback has returned.
     * Synchronous calls become idle once {@link Call#execute() execute()} returns. This means that if
