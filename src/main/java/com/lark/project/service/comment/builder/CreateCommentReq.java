...
public class CreateCommentReq extends BaseRequest {
    @Path
    ...
    @Body
    private CreateCommentReqBody body;


    public CreateCommentReq() {
    }

    public CreateCommentReq(Builder builder) {
    ...
    public CreateCommentReqBody getCreateCommentReqBody() {
        return this.body;
    }

    public void setCreateCommentReqBody(CreateCommentReqBody body) {
        this.body = body;
    }
