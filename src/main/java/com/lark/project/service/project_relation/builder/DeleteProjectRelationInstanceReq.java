...
public class DeleteProjectRelationInstanceReq extends BaseRequest {
    @Path
    ...
    @Body
    private DeleteProjectRelationInstanceReqBody body;


    public DeleteProjectRelationInstanceReq() {
    }

    public DeleteProjectRelationInstanceReq(Builder builder) {
    ...
    public DeleteProjectRelationInstanceReqBody getDeleteProjectRelationInstanceReqBody() {
        return this.body;
    }

    public void setDeleteProjectRelationInstanceReqBody(DeleteProjectRelationInstanceReqBody body) {
        this.body = body;
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            headers = new HashMap<>();
            body = new DeleteProjectRelationInstanceReqBody();
        }
        ...
        public DeleteProjectRelationInstanceReq build() {
            return new DeleteProjectRelationInstanceReq(this);
        }
