...
public class ListProjectBusinessReq extends BaseRequest {
    @Path
    @SerializedName("project_key")
    private String projectKey;

    public ListProjectBusinessReq() {
    }

    public ListProjectBusinessReq(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListProjectBusinessReq build() {
            return new ListProjectBusinessReq(this);
        }
