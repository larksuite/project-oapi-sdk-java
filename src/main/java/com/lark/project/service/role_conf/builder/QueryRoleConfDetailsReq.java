...
public class QueryRoleConfDetailsReq extends BaseRequest {
    @Path
    ...
    public QueryRoleConfDetailsReq() {
    }

    public QueryRoleConfDetailsReq(Builder builder) {
    ...
    public static class Builder {
        ...
        public QueryRoleConfDetailsReq build() {
            return new QueryRoleConfDetailsReq(this);
        }
